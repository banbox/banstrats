...
example_regex='^(TestMainBlankImportRegistersBinanceLongShortSource|TestMainBlankImportRegistersFundingRateSource|TestFundingRateRegistersFuncDataSource|TestFundingRateFetchHistoryWith|TestFundingRateFetchHistoryWithChunksSortsAndDeduplicates|TestFundingRateFetchHistoryRejectsBadInput|TestFundingRateExampleStrategySubscribesSource|TestOpenInterestInfoBindsKlineTable|TestFetchHistoryWithMapsAllFieldsAndUsesHalfOpenRange|TestFetchHistoryWithRejectsMissingFields|TestBinanceLongShortSourceInfo|TestBinanceLongShortRegistersSource|TestBinanceLongShortFetchHistory|TestBinanceLongShortSubscribeLive|TestBinanceLongShortStrategyRegistersAndCollectsSubs|TestBinanceLongShortStrategyOnDataAndDataHubProof|TestBinanceLongShortStrategyIgnoresUnrelatedSource|TestBinanceLongShortStrategyReportsNilDataFields|TestBinanceLongShortStrategyReportsMalformedValues|TestBinanceLongShortDataHubWindowBoundedAndLatestReadable|TestBinanceLongShortDataHubIgnoresLegacyKlineEntriesWithSameSidAndTf)$'
